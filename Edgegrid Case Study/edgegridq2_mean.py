...
average_consumption = merged_df2[half_hour_columns].mean()

plt.figure(figsize=(12, 6))
plt.bar(half_hour_periods, average_consumption)
plt.xlabel('Half-Hour of the Day')
plt.ylabel('Average Energy Consumption')
plt.title('Average Energy Consumption for Each Half-Hour Period')
